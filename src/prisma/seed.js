...
const userId = "acd6fd55-1b7f-4eee-8e85-5462c333e2fc"
...
const main = async () => {
    ...
    let user = await prisma.orm.public.User.first()
    if (!user) {
        user = await prisma.orm.public.User.create({
            id: "acd6fd55-1b7f-4eee-8e85-5462c333e2fc",
            name: "Seed User",
    ...
    for (const movie of movies) {
        ...
        await prisma.orm.public.Movie.create(movie)
